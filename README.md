...
- **Backend**: Node.js, Express, JWT, bcrypt, Mongoose, Nodemon
- **Database**: MongoDB
- **Cloud Integration**: AWS SDK v3
- **AI Integrations**: Google Gemini API
- **Reporting & Notifications**: PDFKit, Nodemailer, node-cron
- **Containerization**: Docker, Docker Compose

## Repository Directory Structure
```
major_project/
├── docker/                 # Docker files & configurations
...
Refer to the respective README files in `backend/` and `frontend/` directories for setup guidelines.
