  ...
  return (
    <div className="min-h-screen bg-[#000000] flex flex-col lg:flex-row relative overflow-hidden select-none font-sans">
      ...
      <div className="w-full lg:w-5/12 flex items-center justify-center p-8 bg-[#030303] z-10 relative">
        <div className="w-full max-w-md bg-zinc-950/80 border border-zinc-900 rounded-2xl p-8 shadow-2xl backdrop-blur-md space-y-8">
          
          {/* Form Header */}
          <div className="space-y-2">
            <h2 className="text-2xl font-bold tracking-tight text-white">Sign In</h2>
            <p className="text-xs text-zinc-500">Access your security intelligence metrics</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black border border-zinc-900 rounded-lg pl-10 pr-4 py-3 text-sm text-white placeholder-zinc-700 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition font-mono"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-black border border-zinc-900 rounded-lg pl-10 pr-10 py-3 text-sm text-white placeholder-zinc-700 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition font-mono"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-orange-600 hover:bg-orange-500 disabled:opacity-50 text-white font-semibold py-3 px-4 rounded-lg text-sm transition-all shadow-lg shadow-orange-500/10 hover:shadow-orange-500/20 active:scale-[0.98] flex justify-center items-center"
            >
              {submitting ? (
          ...
          <div className="pt-6 border-t border-zinc-900 text-center">
            <p className="text-xs text-zinc-500">
              ...
              <Link to="/register" className="text-orange-500 hover:text-orange-400 font-semibold transition">
                Create one
              </Link>
            </p>
          </div>
