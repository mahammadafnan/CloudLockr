...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] flex flex-col lg:flex-row relative overflow-hidden select-none font-sans text-[#1D1D1F]">
      ...
      {/* --- RIGHT SECTION: SLEEK NEUMORPHIC REGISTER FORM --- */}
      <div className="w-full lg:w-5/12 flex items-center justify-center p-8 bg-[#F5F5F7] z-10 relative">
        <div className="w-full max-w-md bg-[#F5F5F7] border border-[#FFFFFF] rounded-3xl p-8 shadow-2xl space-y-6 relative">
          ...
          <div className="space-y-1 text-center lg:text-left">
            <h2 className="text-2xl font-extrabold tracking-tight text-[#1D1D1F]">Create Account.</h2>
            <p className="text-xs text-[#86868B] font-semibold">Register security boundary access permissions.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Afnan"
                  className="w-full bg-[#EFEFEF] border border-[#D2D2D7] rounded-xl pl-10 pr-4 py-2.5 text-sm text-[#1D1D1F] placeholder-[#86868B]/60 focus:outline-none focus:border-[#0071E3] transition neumorphic-input"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#EFEFEF] border border-[#D2D2D7] rounded-xl pl-10 pr-4 py-2.5 text-sm text-[#1D1D1F] placeholder-[#86868B]/60 focus:outline-none focus:border-[#0071E3] transition font-mono neumorphic-input"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-[#86868B] pointer-events-none">
                  <HiBriefcase size={18} />
                </span>
                <select
                  value={role}
                  onChange={(e) => setRole(e.target.value)}
                  className="w-full bg-[#EFEFEF] border border-[#D2D2D7] rounded-xl pl-10 pr-8 py-2.5 text-sm text-[#1D1D1F] focus:outline-none focus:border-[#0071E3] transition appearance-none cursor-pointer neumorphic-input"
                >
                ...
                <span className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-[#86868B] pointer-events-none text-[10px]">
                  ▼
                </span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-[#EFEFEF] border border-[#D2D2D7] rounded-xl pl-10 pr-10 py-2.5 text-sm text-[#1D1D1F] placeholder-[#86868B]/60 focus:outline-none focus:border-[#0071E3] transition font-mono neumorphic-input"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full neumorphic-btn text-[#1D1D1F] font-bold py-3.5 px-4 rounded-xl text-sm transition-all flex justify-center items-center active:scale-[0.98] mt-2"
            >
              {submitting ? (
          ...
          <div className="pt-6 border-t border-[#D2D2D7]/60 text-center">
            <p className="text-xs text-[#86868B]">
              ...
              <Link to="/login" className="text-[#0071E3] hover:underline font-bold transition">
                Sign In
              </Link>
            </p>
          </div>
